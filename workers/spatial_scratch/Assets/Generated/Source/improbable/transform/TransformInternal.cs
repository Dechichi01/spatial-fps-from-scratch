...
namespace Improbable.Transform
{
    public partial class TransformInternal
    {
        ...
        public struct Snapshot : ISpatialComponentSnapshot
        {
            ...
            public Snapshot(global::Improbable.Transform.Location location, global::Improbable.Transform.Quaternion rotation, global::Improbable.Transform.Velocity velocity, uint physicsTick, float ticksPerSecond)
            {
                Location = location;
                Rotation = rotation;
                Velocity = velocity;
        ...
        public static class Serialization
        {
            ...
            public static void SerializeUpdate(Improbable.Transform.TransformInternal.Update update, global::Improbable.Worker.CInterop.SchemaComponentUpdate updateObj)
            {
                var obj = updateObj.GetFields();
                {
                    if (update.Location.HasValue)
                    {
                        ...
                        global::Improbable.Transform.Location.Serialization.Serialize(field, obj.AddObject(1));
                    }
                }
                {
                    if (update.Rotation.HasValue)
                    {
                        ...
                        global::Improbable.Transform.Quaternion.Serialization.Serialize(field, obj.AddObject(2));
                    }
                }
                {
                    if (update.Velocity.HasValue)
                    {
                        ...
                        global::Improbable.Transform.Velocity.Serialization.Serialize(field, obj.AddObject(3));
                    }
                }
                {
            ...
            public static Improbable.Transform.TransformInternal.Update DeserializeUpdate(global::Improbable.Worker.CInterop.SchemaComponentData data)
            {
                var update = new Improbable.Transform.TransformInternal.Update();
            ...
            public static Improbable.Transform.TransformInternal.Snapshot DeserializeSnapshot(global::Improbable.Worker.CInterop.SchemaObject obj)
            {
            ...
            public static void ApplyUpdate(global::Improbable.Worker.CInterop.SchemaComponentUpdate updateObj, ref Improbable.Transform.TransformInternal.Snapshot snapshot)
            {
                var obj = updateObj.GetFields();
        ...
        internal class TransformInternalDynamic : IDynamicInvokable
        {
            ...
            private static Update SnapshotToUpdate(in Snapshot snapshot)
            {
                ...
                update.Location = new Option<global::Improbable.Transform.Location>(snapshot.Location);
                update.Rotation = new Option<global::Improbable.Transform.Quaternion>(snapshot.Rotation);
                update.Velocity = new Option<global::Improbable.Transform.Velocity>(snapshot.Velocity);
