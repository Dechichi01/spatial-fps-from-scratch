...
namespace Improbable.Transform
{
    ...
    public class TransformInternalReader
    {
        ...
        private Dictionary<Action<global::Improbable.Transform.Location>, ulong> locationUpdateCallbackToCallbackKey;
        public event Action<global::Improbable.Transform.Location> OnLocationUpdate
        {
            add
            {
                if (locationUpdateCallbackToCallbackKey == null)
                {
                    locationUpdateCallbackToCallbackKey = new Dictionary<Action<global::Improbable.Transform.Location>, ulong>();
                }
        ...
        private Dictionary<Action<global::Improbable.Transform.Quaternion>, ulong> rotationUpdateCallbackToCallbackKey;
        public event Action<global::Improbable.Transform.Quaternion> OnRotationUpdate
        {
            add
            {
                if (rotationUpdateCallbackToCallbackKey == null)
                {
                    rotationUpdateCallbackToCallbackKey = new Dictionary<Action<global::Improbable.Transform.Quaternion>, ulong>();
                }
        ...
        private Dictionary<Action<global::Improbable.Transform.Velocity>, ulong> velocityUpdateCallbackToCallbackKey;
        public event Action<global::Improbable.Transform.Velocity> OnVelocityUpdate
        {
            add
            {
                if (velocityUpdateCallbackToCallbackKey == null)
                {
                    velocityUpdateCallbackToCallbackKey = new Dictionary<Action<global::Improbable.Transform.Velocity>, ulong>();
                }
