...
namespace Improbable.PlayerLifecycle
{
    ...
    public class PlayerCreatorCommandReceiver
    {
        ...
        private Dictionary<Action<Improbable.PlayerLifecycle.PlayerCreator.CreatePlayer.ReceivedRequest>, ulong> createPlayerCallbackToCallbackKey;

        public event Action<Improbable.PlayerLifecycle.PlayerCreator.CreatePlayer.ReceivedRequest> OnCreatePlayerRequestReceived
        {
            add
            {
                if (createPlayerCallbackToCallbackKey == null)
                {
                    createPlayerCallbackToCallbackKey = new Dictionary<Action<Improbable.PlayerLifecycle.PlayerCreator.CreatePlayer.ReceivedRequest>, ulong>();
                }
        ...
        public void SendCreatePlayerResponse(Improbable.PlayerLifecycle.PlayerCreator.CreatePlayer.Response response)
        {
            commandSystem.SendResponse(response);
        }

        public void SendCreatePlayerResponse(long requestId, global::Improbable.PlayerLifecycle.CreatePlayerResponseType response)
        {
            commandSystem.SendResponse(new Improbable.PlayerLifecycle.PlayerCreator.CreatePlayer.Response(requestId, response));
        }

        public void SendCreatePlayerFailure(long requestId, string failureMessage)
        {
            commandSystem.SendResponse(new Improbable.PlayerLifecycle.PlayerCreator.CreatePlayer.Response(requestId, failureMessage));
        }
