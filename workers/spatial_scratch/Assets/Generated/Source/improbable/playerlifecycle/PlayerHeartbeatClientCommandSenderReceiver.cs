...
namespace Improbable.PlayerLifecycle
{
    ...
    public class PlayerHeartbeatClientCommandSender
    {
        ...
        public void SendPlayerHeartbeatCommand(PlayerHeartbeatClient.PlayerHeartbeat.Request request, Action<Improbable.PlayerLifecycle.PlayerHeartbeatClient.PlayerHeartbeat.ReceivedResponse> callback = null)
        {
            int validCallbackEpoch = callbackEpoch;
            var requestId = commandSender.SendCommand(request, entity);
            if (callback != null)
            {
                Action<Improbable.PlayerLifecycle.PlayerHeartbeatClient.PlayerHeartbeat.ReceivedResponse> wrappedCallback = response =>
                {
    ...
    public class PlayerHeartbeatClientCommandReceiver
    {
        ...
        private Dictionary<Action<Improbable.PlayerLifecycle.PlayerHeartbeatClient.PlayerHeartbeat.ReceivedRequest>, ulong> playerHeartbeatCallbackToCallbackKey;

        public event Action<Improbable.PlayerLifecycle.PlayerHeartbeatClient.PlayerHeartbeat.ReceivedRequest> OnPlayerHeartbeatRequestReceived
        {
            add
            {
                if (playerHeartbeatCallbackToCallbackKey == null)
                {
                    playerHeartbeatCallbackToCallbackKey = new Dictionary<Action<Improbable.PlayerLifecycle.PlayerHeartbeatClient.PlayerHeartbeat.ReceivedRequest>, ulong>();
                }
        ...
        public void SendPlayerHeartbeatResponse(Improbable.PlayerLifecycle.PlayerHeartbeatClient.PlayerHeartbeat.Response response)
        {
        ...
        {
            commandSystem.SendResponse(new Improbable.PlayerLifecycle.PlayerHeartbeatClient.PlayerHeartbeat.Response(requestId, failureMessage));
        }
