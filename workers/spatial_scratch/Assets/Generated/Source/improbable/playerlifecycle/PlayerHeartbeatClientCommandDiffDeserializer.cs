...
namespace Improbable.PlayerLifecycle
{
    ...
    {
        public class PlayerHeartbeatDiffCommandDeserializer : ICommandDiffDeserializer
        {
            ...
            public void AddRequestToDiff(CommandRequestOp op, ViewDiff diff)
            {
                ...
                var request = new PlayerHeartbeat.ReceivedRequest(
            ...
            public void AddResponseToDiff(CommandResponseOp op, ViewDiff diff, CommandMetaDataAggregate commandMetaData)
            {
                ...
                var commandContext = commandMetaData.GetContext<global::Improbable.Common.Empty>(ComponentId, 1, op.RequestId);
        ...
        public class PlayerHeartbeatCommandSerializer : ICommandSerializer
        {
            public uint GetComponentId()
            {
                return ComponentId;
            ...
            {
                var storage = (PlayerHeartbeatCommandsToSendStorage) messages.GetCommandSendStorage(ComponentId, 1);
                ...
                for (int i = 0; i < requests.Count; ++i)
                {
                    ...
                    commandMetaData.AddRequest<global::Improbable.Common.Empty>(ComponentId, 1, in context);
