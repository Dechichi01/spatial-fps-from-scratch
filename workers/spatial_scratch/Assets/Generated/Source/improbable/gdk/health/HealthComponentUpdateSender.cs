    ...
    public partial class HealthComponent
    {
        internal class ComponentReplicator : IComponentReplicationHandler
        {
            ...
            public EntityArchetypeQuery ComponentUpdateQuery => new EntityArchetypeQuery
            {
                All = new[]
                {
                    ComponentType.Create<Improbable.Gdk.Health.HealthComponent.Component>(),
                    ComponentType.Create<Improbable.Gdk.Health.HealthComponent.ComponentAuthority>(),
                ...
                ComponentUpdateSystem componentUpdateSystem)
            {
                ...
                var componentType = system.GetArchetypeChunkComponentType<Improbable.Gdk.Health.HealthComponent.Component>();
