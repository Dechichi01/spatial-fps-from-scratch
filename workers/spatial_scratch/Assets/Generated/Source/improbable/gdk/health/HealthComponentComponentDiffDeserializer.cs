    ...
    public partial class HealthComponent
    {
        ...
        public class ComponentSerializer : IComponentSerializer
        {
            ...
            public void Serialize(MessagesToSend messages, SerializedMessagesToSend serializedMessages)
            {
                ...
                {
                    var events = ((IDiffEventStorage<HealthModified.Event>) storage).GetEvents();
                    ...
                    for (int i = 0; i < events.Count; ++i)
                    {
                        ...
                        global::Improbable.Gdk.Health.HealthModifiedInfo.Serialization.Serialize(ev.Event.Payload, obj);
                ...
                {
                    var events = ((IDiffEventStorage<Respawn.Event>) storage).GetEvents();
                    ...
                    for (int i = 0; i < events.Count; ++i)
                    {
                        ...
                        global::Improbable.Common.Empty.Serialization.Serialize(ev.Event.Payload, obj);
                        serializedMessages.AddComponentUpdate(componentUpdate, ev.EntityId.Id);
