    ...
    public partial class HealthComponent
    {
        public class EcsViewManager : IEcsViewManager
        {
            ...
            private void RemoveComponent(EntityId entityId)
            {
                ...
                entityManager.RemoveComponent<Improbable.Gdk.Health.HealthComponent.Component>(entity);
            }
            ...
            private void ApplyUpdate(in ComponentUpdateReceived<Update> update, ComponentDataFromEntity<Component> dataFromEntity)
            {
                ...
                if (update.Update.Health.HasValue)
                {
                    data.Health = update.Update.Health.Value;
                }

                if (update.Update.MaxHealth.HasValue)
                {
                    data.MaxHealth = update.Update.MaxHealth.Value;
                }
