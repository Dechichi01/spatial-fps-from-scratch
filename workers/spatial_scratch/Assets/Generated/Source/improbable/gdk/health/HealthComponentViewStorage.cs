...
namespace Improbable.Gdk.Health
{
    ...
    {
        public class HealthComponentViewStorage : IViewStorage, IViewComponentStorage<Snapshot>,
            IViewComponentUpdater<Update>
        {
            ...
            public void ApplyUpdate(long entityId, in Update update)
            {
                ...
                {
                    data.Health = update.Health.Value;
                }

                if (update.MaxHealth.HasValue)
                {
                    data.MaxHealth = update.MaxHealth.Value;
                }
